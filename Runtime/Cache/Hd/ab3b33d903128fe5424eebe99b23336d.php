...
<style type="text/css">
    ...
    #empty_course_bg{
        ...
        top:182px;
        left:90px;	
        background-image:url(/static/v1/hd/images/course/my/empty_bg.jpg);
    }
    /* 底部投影背景图 */
    .shadow{
        position:absolute;
...
var buttons=
	[
        ...
        /* 当课程列表不为空 */
        {id:'course_1',name:'',action:'',linkImage:'',focusImage:'',selectBox:'/static/v1/hd/images/common/select_box_1.png',left:'ch_1',right:'course_2',up:'ch_1',down:'course_6'},
		{id:'course_2',name:'',action:'',linkImage:'',focusImage:'',selectBox:'/static/v1/hd/images/common/select_box_1.png',left:'course_1',right:'course_3',up:'ch_3',down:['course_7','course_6']},
		{id:'course_3',name:'',action:'',linkImage:'',focusImage:'',selectBox:'/static/v1/hd/images/common/select_box_1.png',left:'course_2',right:'course_4',up:'ch_3',down:['course_8','course_7','course_6']},
		{id:'course_4',name:'',action:'',linkImage:'',focusImage:'',selectBox:'/static/v1/hd/images/common/select_box_1.png',left:'course_3',right:'course_5',up:'ch_3',down:['course_9','course_8','course_7','course_6']},
		{id:'course_5',name:'',action:'',linkImage:'',focusImage:'',selectBox:'/static/v1/hd/images/common/select_box_1.png',left:'course_4',right:'course_6',up:'ch_3',down:['course_10','course_9','course_8','course_7','course_6']},
        ...
        /* 课程为空时选择课程 */
        {id:'empty_course',name:'',action:'',linkImage:'/static/v1/hd/images/course/my/select_course.png',focusImage:'/static/v1/hd/images/course/my/select_course_over.png',selectBox:'',up:'ch_1'},
	];
...
<div id="div_empty_course" href="<?php echo U('Course/all');?>" style="position:absolute;width:98px;height:40px;left:145px;top:300px;text-align:center;">
	<img id="empty_course" src="/static/v1/hd/images/course/my/select_course.png" width="98" height="40">
</div><?php endif; ?>
<!-- 我的课程结束 -->
</body>
</html>