...
<?php if(is_array($gradeList)): $i = 0; $__LIST__ = $gradeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$grade): $mod = ($i % 2 );++$i; $left = 310+($i-1)*80; ?>
    <div id="div_grade_<?php echo ($i); ?>" title="<?php echo U('Course/grade');?>" style="position:absolute;width:80px;height:38px;left:<?php echo ($left); ?>px;top:80px;text-align:center;">
