...
<form id="form" action="<?php echo U('Role/changeNum');?>" method="post" style="padding:10px">
	<?php $__FOR_START_5795__=1;$__FOR_END_5795__=$count+1;for($i=$__FOR_START_5795__;$i < $__FOR_END_5795__;$i+=1){ ?><input type="hidden" id="option_<?php echo ($i); ?>ID" name="option_<?php echo ($i); ?>" value=""/><?php } ?>
</form>
