...
class SectionListController extends CommonController {
	...
	private function early($chKey,$course){
		...
		for ($i=0; $i<12; $i++){
			...
			$months[$i]['linkImage'] = get_upfile_url("__SD__/images/sectionList/early/month/". $id ."_over.png");
			$months[$i]['focusImage'] = get_upfile_url("__SD__/images/sectionList/early/month/". $id .".png");
		}
